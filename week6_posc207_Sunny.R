...
############################################
# Creating Plot Method for Class: posc_207 #
# This will let you then just call plot()  #
# on a object of class "posc_207"          #
############################################
...
##################################
# Make Adjustments               #
# (note: cannot change defaults  #
# like main= and xlab, ylab)     #
##################################
